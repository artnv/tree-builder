...
require_once "TreeBuilder/SelectTree.php";

use TreeBuilder\HtmlTree;
use TreeBuilder\SelectTree;
...
$selectTree = SelectTree::create($data, [], [
    'selected' => 2
], false)->showTree();
...
$parents = $_htmlTree->getParents([
    'id' => 777,
    'title' => 'this',
    'parent' => 24
]);
$childs = $_htmlTree->getChilds([
    'id' => 56
]);
	...
	<div class="main">
		...
		<div class="result">
			<div class="pull-right">
				<p>
					<strong>Sort with ['position']</strong>
				</p><?=$htmlTreeWithSort;?></div>
			<div class="pull-left">
				<p>
		...
		<div class="result">
			<p>
				As breadcrumbs:<br> <?=getBreadcrumbs($parents);?></p>
